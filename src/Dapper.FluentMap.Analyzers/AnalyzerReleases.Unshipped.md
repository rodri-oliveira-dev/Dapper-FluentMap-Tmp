...
--------|----------|----------|--------------------
DFM001 | Dapper.FluentMap.Configuration | Error | Map expression must resolve to a property path.
DFM002 | Dapper.FluentMap.Configuration | Error | Property path is mapped more than once.
